...
const DocumentModal = ({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let message = err.response?.data?.detail || err.response?.data?.message || null;
    ...
    return (
        <div className={`fixed inset-0 z-[60] overflow-y-auto ${isDarkMode ? 'dark' : ''}`}>
            {/* Backdrop with blur */}
            <div 
                                        ...
                                        <div 
                                            ...
                                            className={`
                                                ...
                                                ${formData.confidentiality_level === level 
                                                    ...
                                                    : (isDarkMode ? 'bg-slate-900 border-slate-700 text-slate-500 hover:border-slate-500' : 'bg-white border-gray-100 text-gray-400 hover:border-gray-200 hover:bg-gray-50')}
