                ...
                <div className="flex justify-between h-16">
                    <div className="flex items-center">
                        ...
                        <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                            ...
                            {(user?.is_staff || user?.username === user?.portal_inbox_username) && (
                                <Link to="/portal-inbox" className="border-transparent text-purple-600 font-semibold inline-flex items-center px-1 pt-1 border-b-2 border-purple-500 text-sm">
                                    Portal Inbox
                                </Link>
                            )}
                        </div>
